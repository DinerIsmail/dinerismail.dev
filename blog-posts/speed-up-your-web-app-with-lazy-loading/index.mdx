...
You may be surprised, but this change, albeit a simple one, is likely to be the most impactful change we could make to improve performance (without actually removing features that is :D). If it's a low hanging fruit, let's just grab it and eat it!
