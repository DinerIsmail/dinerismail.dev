...
In this post I want to share how I built this platform, the challenges I've gone through as well as my learnings from the process.
...
Most of the API routes interact with a Postgresql database hosted on Digital Ocean. I use Prisma the data model, to manage migrations and to run queries. I'm finding Prisma very helpful at this point, as it makes it a breeze to run the migrations and write type-safe queries.
